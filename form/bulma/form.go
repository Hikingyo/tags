...
//Form is the bulma version of Form
type Form struct {
	*form.Form
}

//New creates a bulma Form from passed options
func New(opts tags.Options) *Form {
	return &Form{form.New(opts)}
}

//CheckboxTag builds a bulma checkbox with passed options
...
//FileTag builds a bulma input[type=file] with passed options
