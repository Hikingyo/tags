...
func Test_InputFieldLabel(t *testing.T) {
	...
	r.Equal(`<div class="field"><div class="field-label is-normal"><label>Custom</label></div><div class="control"><input class="input" id="-Name" name="Name" type="text" value="" /></div></div>`, l.String())
}
...
func Test_InputFieldLabelWithAchronym(t *testing.T) {
	...
	for key, expectedLabel := range cases {
		...
		r.Equal(`<div class="field"><div class="label-field is-normal"><label>`+expectedLabel+`</label></div><div class="control"><input class=" input" id="-`+key+`" name="`+key+`" type="text" value="" /></div></div>`, l.String())
	}
}
